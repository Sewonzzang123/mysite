						...
						<li>
							<table>
								<tr>
									...
									<td>${user.name }</td>
									<td>${fn:replace(user.regDate,".0","") }</td>
									<td><a
										href="${pageContext.request.contextPath }/guestbook?a=deleteform&no=${user.no}">삭제</a></td>
								</tr>
								<tr>
									<td colspan=4>${fn:replace(user.message,newline,"<br/>") }</td>
								</tr>
							</table> <br>
						</li>
