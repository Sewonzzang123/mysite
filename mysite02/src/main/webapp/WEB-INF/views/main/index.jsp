...
<link href="<%=request.getContextPath() %>/assets/css/main.css" rel="stylesheet" type="text/css"></head>
<body>
	<div id="container">
		<div id="header">
			<h1>MySite</h1>
		...
		<img id="profile" src="<%=request.getContextPath() %>/assets/images/recycle.png" style="width:120px">
</body>
</html>